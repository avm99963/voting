...
<form action="doeditvoting.php" method="POST" autocomplete="OFF">
  ...
  <div class="mdl-dialog__content">
    ...
    <br>
    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
      <input class="mdl-textfield__input" type="datetime-local" name="datebegins" id="datebegins" autocomplete="off" value="<?=date("Y-m-d\TH:i:s", $row["datebegins"])?>"></textarea>
      <label class="mdl-textfield__label always-focused" for="datebegins"><?=$i18n->msg("datebegins")?></label>
    </div>
    <br>
    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
      <input class="mdl-textfield__input" type="datetime-local" name="dateends" id="dateends" autocomplete="off" value="<?=date("Y-m-d\TH:i:s", $row["dateends"])?>"></textarea>
